...
Build SOVRANOCOIN Core
------------------------

1. Clone the SOVRANOCOIN Core source code:
...
SOVRANOCOIN Core is now available at `./src/sovranocoind`
...
The first time you run sovranocoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
