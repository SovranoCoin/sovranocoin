...
In order to support loading of multiple wallets in sovranocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sovranocoin.cpp.
...
Changes to sovranocoin.cpp
----------------------
sovranocoin.cpp is the entry point into sovranocoin-qt, and as such, will require some minor modifications to provide hooks for
