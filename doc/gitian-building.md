...
*Setup instructions for a gitian build of SOVRANOCOIN Core using a VM or physical system.*
...
to the SOVRANOCOIN GitHub release page.
...
- [Building SOVRANOCOIN Core](#building-sovranocoin-core)
...
[gitian.sigs](https://github.com/sovranocoin-project/gitian.sigs/) repository:
...
You can also mail the files to Fuzzbawls (fuzzbawls@sovranocoin.org) and he will commit them.
