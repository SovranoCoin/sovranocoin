...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/SOVRANOCOIN-Project/SOVRANOCOIN/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/sovranocoin-project/sovranocoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
By default, Gitian will fetch source files as needed. To cache them ahead of time, make sure you have checked out the tag you want to build in sovranocoin, then:
...
### Build and sign SOVRANOCOIN Core for Linux, Windows, and macOS:
...
Build output expected:
  ...
  4. macOS unsigned installer and dist tarball (`sovranocoin-${VERSION}-osx-unsigned.dmg`, `sovranocoin-${VERSION}-osx64.tar.gz`)
...
- Detached signatures will then be committed to the [sovranocoin-detached-sigs](https://github.com/sovranocoin-Project/sovranocoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/SOVRANOCOIN-Project/SOVRANOCOIN/releases/new) with a link to the archived release notes.
