...
This document provides guidelines for internationalization of the SOVRANOCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sovranocoin_en.ts` remains unchanged.
