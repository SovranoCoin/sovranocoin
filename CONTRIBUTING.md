Contributing to SOVRANOCOIN Core
============================

The SOVRANOCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/sovranocoin-project/sovranocoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SOVRANOCOIN Core project, and is not to be
confused with overall SOVRANOCOIN Network Protocol consensus changes.

Whether a pull request is merged into SOVRANOCOIN Core rests with the project merge
...
Patches that change SOVRANOCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the SOVRANOCOIN consensus, it must have been
...
The project leader is the release manager for each SOVRANOCOIN Core release.
