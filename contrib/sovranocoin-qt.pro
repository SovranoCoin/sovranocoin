...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/sovranocoin-cli.cpp \
           src/sovranocoin-tx.cpp \
           src/sovranocoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/sovranocoin.qrc src/qt/sovranocoin_locale.qrc

TRANSLATIONS += src/qt/locale/sovranocoin_bg.ts \
                src/qt/locale/sovranocoin_de.ts \
                src/qt/locale/sovranocoin_en.ts \
                src/qt/locale/sovranocoin_es.ts \
                src/qt/locale/sovranocoin_fi.ts \
                src/qt/locale/sovranocoin_fr.ts \
                src/qt/locale/sovranocoin_it.ts \
                src/qt/locale/sovranocoin_ja.ts \
                src/qt/locale/sovranocoin_pl.ts \
                src/qt/locale/sovranocoin_pt.ts \
                src/qt/locale/sovranocoin_ru.ts \
                src/qt/locale/sovranocoin_sk.ts \
                src/qt/locale/sovranocoin_sv.ts \
