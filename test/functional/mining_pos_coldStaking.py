...
from test_framework.sovranocoin_node import SovranocoinTestNode
...
class SOVRANOCOIN_ColdStakingTest(SovranocoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(SovranocoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 SVR from the pot)
...
if __name__ == '__main__':
    SOVRANOCOIN_ColdStakingTest().main()
