...
#ifndef SOVRANOCOIN_ZSVRTRACKER_H
#define SOVRANOCOIN_ZSVRTRACKER_H
...
public:
    CzSVRTracker(CWallet* parent);
    ~CzSVRTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSVRWallet* zSVRWallet = NULL);
