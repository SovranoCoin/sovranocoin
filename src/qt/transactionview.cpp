                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received SVR from zSVR"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSVR"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSVR));
