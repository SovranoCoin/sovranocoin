...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            SOVRANOCOINGUI* window = static_cast<SOVRANOCOINGUI*>(parentWidget());
...
{
    SOVRANOCOINGUI* gui = static_cast<SOVRANOCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<SOVRANOCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("SOVRANOCOIN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your SVRs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
