...
/** Utility functions used by the SovranoCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SovranoCoin addresses in monospace font
...
// Parse "sovranocoin:" URI into recipient object, return true on successful parsing
