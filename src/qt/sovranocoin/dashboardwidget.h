...
#include "config/sovranocoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalSvr = 0;
    qint64 totalZsvr = 0;
    QList<qreal> valuesSvr;
    QList<qreal> valueszSvr;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(SOVRANOCOINGUI* _window);
    ~DashboardWidget();
