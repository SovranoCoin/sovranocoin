...
#include "qt/sovranocoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SOVRANOCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SOVRANOCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
