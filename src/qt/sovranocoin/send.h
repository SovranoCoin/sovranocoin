...
#include "qt/sovranocoin/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(SOVRANOCOINGUI* parent);
    ~SendWidget();
...
private Q_SLOTS:
    void onSVRSelected(bool _isSVR);
    void onSendClicked();
...
private:
    ...
    bool sendZsvr(QList<SendCoinsRecipient> recipients);
