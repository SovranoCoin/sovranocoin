...
#include "qt/sovranocoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(SOVRANOCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &SOVRANOCOINGUI::openFAQ);
