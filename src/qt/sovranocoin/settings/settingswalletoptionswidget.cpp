...
#include "qt/sovranocoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/sovranocoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SOVRANOCOINGUI* _window, QWidget *parent) :
