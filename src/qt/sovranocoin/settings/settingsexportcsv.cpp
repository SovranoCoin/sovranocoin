...
#include "qt/sovranocoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(SOVRANOCOINGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("SOVRANOCOIN_tx_csv_export(*.csv)") : tr("SOVRANOCOIN_addresses_csv_export(*.csv)"),
                                        nullptr);
