...
#include "qt/sovranocoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/sovranocoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SOVRANOCOINGUI* _window, QWidget *parent) :
