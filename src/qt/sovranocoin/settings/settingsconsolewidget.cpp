...
#include "qt/sovranocoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/sovranocoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(SOVRANOCOINGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SOVRANOCOIN RPC console.") + "<br>" +
