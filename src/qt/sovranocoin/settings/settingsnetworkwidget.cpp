...
#include "qt/sovranocoin/settings/settingsnetworkwidget.h"
#include "qt/sovranocoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/sovranocoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SOVRANOCOINGUI* _window, QWidget *parent) :
