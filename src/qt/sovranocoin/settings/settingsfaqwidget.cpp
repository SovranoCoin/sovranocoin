...
#include "qt/sovranocoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/sovranocoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(SOVRANOCOINGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableSVR,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableSVR,
    ...
    connect(ui->pushButton_UnspendableSVR, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableSVR);});
    ...
    if (parent)
        connect(parent, &SOVRANOCOINGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
