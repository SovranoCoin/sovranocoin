...
#include <QWidget>
#include <QString>
#include "qt/sovranocoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(SOVRANOCOINGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    SOVRANOCOINGUI* getWindow() { return this->window; }
