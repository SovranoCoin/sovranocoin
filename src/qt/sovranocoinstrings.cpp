...
QT_TRANSLATE_NOOP("sovranocoin-core", ""
"Disable all SOVRANOCOIN specific functionality (Masternodes, Zerocoin, SwiftX, "
...
QT_TRANSLATE_NOOP("sovranocoin-core", ""
"Enable or disable staking functionality for SVR inputs (0-1, default: %u)"),
QT_TRANSLATE_NOOP("sovranocoin-core", ""
"Enable or disable staking functionality for zSVR inputs (0-1, default: %u)"),
QT_TRANSLATE_NOOP("sovranocoin-core", ""
...
"is wrong SOVRANOCOIN Core will not work properly."),
QT_TRANSLATE_NOOP("sovranocoin-core", ""
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Append comment to the user agent string"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Cannot create public spend input"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Cannot upgrade to HD wallet (already running HD support). Version: %d"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Copyright (C) 2015-%i The SOVRANOCOIN Core Developers"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Error writing zerocoinDB to disk"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Error: No valid utxo!"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Failed to find Zerocoins in wallet.dat"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("sovranocoin-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Failed to parse public spend"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Failed to read block"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Failed to select a zerocoin"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Failed to wipe zerocoinDB"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Failed to write coin serial number into wallet"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Invalid amount for -%s=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Loading banlist..."),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Location of the auth cookie (default: data dir)"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Lock masternodes from masternode configuration file (default: %u)"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Lookup(): Invalid -proxy address or hostname: '%s'"),
QT_TRANSLATE_NOOP("sovranocoin-core", "MNs synchronization pending..."),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Mint did not make it into blockchain"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Need destination or change address because change is not exact"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Number of custom location backups to retain (default: %d)"),
QT_TRANSLATE_NOOP("sovranocoin-core", "On first run, create a legacy wallet instead of a HD wallet"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Peers are being disconnected due time differences."),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Pubcoin not found in mint tx"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Recalculating SVR supply..."),
QT_TRANSLATE_NOOP("sovranocoin-core", "Reindex the SVR and zSVR money supply statistics"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Reindexing zerocoin database..."),
QT_TRANSLATE_NOOP("sovranocoin-core", "Reindexing zerocoin failed"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Selected coins value is less than payment target"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Spend Valid"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Syncing zSVR wallet..."),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Too many spends needed"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Transaction Created"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Transaction Mint Started"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Trying to spend an already spent serial #, try again."),
QT_TRANSLATE_NOOP("sovranocoin-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Unable to find transaction containing mint %s"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Unable to find transaction containing mint, txHash: %s"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Unable to generate initial key"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Unable to generate keys"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("sovranocoin-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Unsupported logging category %s=%s."),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Use block spam filter (default: %u)"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Use the test network"),
QT_TRANSLATE_NOOP("sovranocoin-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("sovranocoin-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Value is below the smallest available denomination (= 1) of zSVR"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "You don't have enough Zerocoins in your wallet"),
...
QT_TRANSLATE_NOOP("sovranocoin-core", "Zerocoin minting available only on regtest"),
QT_TRANSLATE_NOOP("sovranocoin-core", "Zerocoin options:"),
QT_TRANSLATE_NOOP("sovranocoin-core", "isValid(): Invalid -proxy address or hostname: '%s'"),
