...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SVR);
    unitlist.append(mSVR);
    unitlist.append(uSVR);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SVR:
        return QString("sovranocoin");
    case mSVR:
        return QString("msovranocoin");
    case uSVR:
        return QString::fromUtf8("usovranocoin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZsvr)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSVR)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZSVR);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSVR)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZSVR));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
