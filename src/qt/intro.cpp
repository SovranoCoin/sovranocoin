...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SovranoCoin Core"),
     ...
     * override -datadir in the sovranocoin.conf file in the default data directory
     * (to be consistent with sovranocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
