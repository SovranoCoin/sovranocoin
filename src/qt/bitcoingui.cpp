                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SovranoCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SovranoCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sovranocoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSVR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SovranoCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SovranoCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SovranoCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SovranoCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SovranoCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a SovranoCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SovranoCoin Core help message to get a list with possible SovranoCoin command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SovranoCoin network", "", count));
}
