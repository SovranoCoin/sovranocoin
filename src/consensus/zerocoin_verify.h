...
#ifndef SOVRANOCOIN_CONSENSUS_ZEROCOIN_VERIFY_H
#define SOVRANOCOIN_CONSENSUS_ZEROCOIN_VERIFY_H
...
bool RecalculateSVRSupply(int nHeightStart, bool fSkipZsvr = true);
