...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SovranoCoin Core sovranocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sovranocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sovranocoin transaction") + "\n" +
                               "  sovranocoin-tx [options] -create [commands]   " + _("Create hex-encoded sovranocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sovranocoin transaction
