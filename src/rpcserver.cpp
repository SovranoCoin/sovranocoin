...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SovranoCoin features */
        {"sovranocoin", "masternode", &masternode, true, true, false},
        ...
        {"sovranocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        ...
        {"sovranocoin", "mnbudget", &mnbudget, true, true, false},
        ...
        {"sovranocoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"sovranocoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sovranocoind, or the -server option to sovranocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6611/\n";
}
