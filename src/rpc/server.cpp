...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"sovranocoin", "listmasternodes", &listmasternodes, true },
        {"sovranocoin", "getmasternodecount", &getmasternodecount, true },
        {"sovranocoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"sovranocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"sovranocoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"sovranocoin", "masternodecurrent", &masternodecurrent, true },
        {"sovranocoin", "masternodedebug", &masternodedebug, true },
        {"sovranocoin", "startmasternode", &startmasternode, true },
        {"sovranocoin", "createmasternodekey", &createmasternodekey, true },
        {"sovranocoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"sovranocoin", "listmasternodeconf", &listmasternodeconf, true },
        {"sovranocoin", "getmasternodestatus", &getmasternodestatus, true },
        {"sovranocoin", "getmasternodewinners", &getmasternodewinners, true },
        {"sovranocoin", "getmasternodescores", &getmasternodescores, true },
        {"sovranocoin", "preparebudget", &preparebudget, true },
        {"sovranocoin", "submitbudget", &submitbudget, true },
        {"sovranocoin", "mnbudgetvote", &mnbudgetvote, true },
        {"sovranocoin", "getbudgetvotes", &getbudgetvotes, true },
        {"sovranocoin", "getnextsuperblock", &getnextsuperblock, true },
        {"sovranocoin", "getbudgetprojection", &getbudgetprojection, true },
        {"sovranocoin", "getbudgetinfo", &getbudgetinfo, true },
        {"sovranocoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"sovranocoin", "mnfinalbudget", &mnfinalbudget, true },
        {"sovranocoin", "checkbudgets", &checkbudgets, true },
        {"sovranocoin", "mnsync", &mnsync, true },
        {"sovranocoin", "spork", &spork, true },
        ...
        {"zerocoin", "getzsvrseed", &getzsvrseed, false },
        {"zerocoin", "setzsvrseed", &setzsvrseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzsvr", &searchdzsvr, false },
        {"zerocoin", "dzsvrstate", &dzsvrstate, false },
